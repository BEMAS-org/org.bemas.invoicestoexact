 ...
 */
class CRM_Invoicestoexact_Upgrader extends CRM_Extension_Upgrader_Base {

  // By convention, functions that look like "function upgrade_NNNN()" are
  // upgrade tasks. They are executed in order (like Drupal's hook_update_N).

  /**
   * Initiate the config so the required items are created if necessary
   */
  ...
  public function uninstall() {
    CRM_Invoicestoexact_Config::uninstallOptionGroups();
  }
  ...
  public function enable() {
    CRM_Invoicestoexact_Config::enableOptionGroups();
  }
  ...
  public function disable() {
    CRM_Invoicestoexact_Config::disableOptionGroups();
  }
